  ...
  async function approveLink() {
    if (isConnected) {
      ...
      try {
        ...
        const spender = "0x244274e5411faE385fF3655DC61D948b13FfC807";
        const amountToApprove = ethers.utils.parseUnits("1", decimals); // 1 Link
...
export default ApproveLinkButton;