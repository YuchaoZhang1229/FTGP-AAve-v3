...
const Balance: React.FC<Props> = ({ tokenAddress, decimals }) => {
    const contractAddress = tokenAddress; // ERC20 token address
    const abi = [
        {
            "inputs": [
                {
    ...
    async function getBalance() {
        if (isConnected) {
            ...
            try {
                ...
                const formattedBalance = balance && ethers.utils.formatUnits(balance, decimals);
